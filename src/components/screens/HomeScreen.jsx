      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 space-y-7">
        ...
        <div className="flex items-center justify-between border-b border-slate-200 pb-3">
          ...
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-emerald-600 hover:bg-emerald-700 text-white shadow-xs transition cursor-pointer"
          >
            <Plus size={14} />
            <span>Create / Toss Match</span>
          </button>
        </div>
